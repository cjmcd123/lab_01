...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    test_volume_of_cube = volume_of_cube( 10 )
    assert_equal(1000, test_volume_of_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    test_volume_of_sphere = volume_of_sphere(10)
    assert_equal(4188, test_volume_of_sphere)
  end

  # #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    test_fahrenheit_to_celsius = fahrenheit_to_celsius(50)
    assert_equal(10, test_fahrenheit_to_celsius)
  end
